<template>
  <div class="mod-category">
    <el-form :inline="true" :model="dataForm">
      <el-form-item>
        <el-button v-if="isAuth('prod:category:save')" type="primary" icon="el-icon-plus" size="small"
    ...
    <el-table :data="dataList" border row-key="categoryId" style="width: 100%;">
      ...
      <el-table-column header-align="center" align="center" label="操作" width="200">
        <template slot-scope="scope">
          <el-button v-if="isAuth('prod:category:update')" type="primary" size="small"
                     @click="addOrUpdateHandle(scope.row.categoryId)">修改</el-button>
          <el-button v-if="isAuth('prod:category:delete')" type="danger" size="small"
