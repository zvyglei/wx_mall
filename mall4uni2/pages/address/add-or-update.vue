<template>
	...
	<view class="container">
		...
		<view class="input-box">
			...
			<view class="section" v-if="">
				<text>默认地址</text>
				<u-switch :value="commonAddr" :activeValue="1" :inactiveValue="0" @input="ontest"></u-switch>
			</view>
		</view>
		<!-- end input列表 -->
		<!-- 功能按钮 -->
		<view class="btn-box u-flex" v-if="addrId!=0">
			<u-button type="primary" text="保存收货地址" @tap="onSaveAddr" shape="circle"></u-button>
			<u-button type="error" text="删除收货地址" @tap="onDeleteAddr" shape="circle"></u-button>
		</view>
